...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { VOneIdentity, VOneSponsorship, VOneUser, VOneRole, VOneTeamMember, AuthProvider } from './src/stores/auth'
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly useApiKeyStore: UnwrapRef<typeof import('./src/stores/api-key')['useApiKeyStore']>
    ...
    readonly useCopy: UnwrapRef<typeof import('./src/composables/useCopy')['useCopy']>
