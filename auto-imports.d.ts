...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { Sponsorship, Identity, User } from './lib/stores/auth'
  import('./lib/stores/auth')
  // @ts-ignore
  export type { Banner } from './lib/stores/banners'
  import('./lib/stores/banners')
  // @ts-ignore
  export type { Bin } from './lib/stores/bins'
  import('./lib/stores/bins')
  // @ts-ignore
  export type { SendowlDownloadItem, SendowlDownload } from './lib/stores/downloads'
  import('./lib/stores/downloads')
  // @ts-ignore
  export type { Notification, NotificationsState } from './lib/stores/notifications'
  import('./lib/stores/notifications')
  // @ts-ignore
  export type { ShopifyProduct, State } from './lib/stores/products'
  import('./lib/stores/products')
  // @ts-ignore
  export type { Promotion } from './lib/stores/promotions'
  import('./lib/stores/promotions')
  // @ts-ignore
  export type { Snackbar, SnackbarQueueState } from './lib/stores/queue'
  import('./lib/stores/queue')
  // @ts-ignore
  export type { Suit, SettingsState } from './lib/stores/settings'
  import('./lib/stores/settings')
  // @ts-ignore
  export type { SiteState } from './lib/stores/site'
  import('./lib/stores/site')
  // @ts-ignore
  export type { Sponsor, SponsorState } from './lib/stores/sponsors'
  import('./lib/stores/sponsors')
  // @ts-ignore
